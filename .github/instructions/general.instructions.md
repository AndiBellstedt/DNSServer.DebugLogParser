---
applyTo: '**'
description: 'General coding guidelines and best practices for the module'
---

# General Coding Guidelines for the project
- Respect the module manifest the understand what is the supported PSVersion and dependencies.
...
- Security is a top priority, ensure that the code does not introduce security vulnerabilities
- Do no stupid things that could lead to security vulnerabilities, such as
...
## Build and maintain a comprehensive about_ .help.txt file for the module
- The about help file must be placed in the 'DNSServer.DebugLogParser\en-US' subfolder of the project
- The about help file must follow the standard PowerShell about help file format
...
- The about help file should has to include the following sections at least:
    - SYNOPSIS
    - SHORT DESCRIPTION
    - LONG DESCRIPTION
