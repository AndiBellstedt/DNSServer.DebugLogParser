...
Remove-Module DNSServer.DebugLogParser -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\DNSServer.DebugLogParser\DNSServer.DebugLogParser.psd1"
Import-Module "$PSScriptRoot\..\DNSServer.DebugLogParser\DNSServer.DebugLogParser.psm1" -Force
